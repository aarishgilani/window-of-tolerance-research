...
1. Ventral Vagal attempts to resolve all challenges first (social engagement, nuanced communication, co-regulation)
2. If this fails — if the environment requires more than connection can handle — Ventral brake releases → Sympathetic mobilization activates
3. If Sympathetic mobilization fails or the threat is inescapable → Dorsal Vagal shutdown engages

This is **Jacksonian Dissolution**: newest circuits go offline first, oldest circuits take over last. (Lesson 3)
...
Because the stack is a phylogenetic sequence, ascending from Dorsal shutdown back to Ventral safety requires traversing the layers in order. You cannot skip Sympathetic mobilization on the way up. See [[no-skips-rule]].

The "thaw" from Dorsal → Sympathetic commonly presents as:
- A sudden surge of anxiety, irritability, or anger
- Heat in the chest or face
- Strong urge to move, pace, or shake
- A sense of urgency or restlessness

This is the necessary metabolic fuel to climb back to Ventral. Interpreting it as regression or failure reinforces immobilization. (Lessons 3, 5)
