...
Video calls strip prosody from the voice (compression artifacts, latency, flat dynamics) and reduce facial expression to a small, screen-sized window with artificial lighting. The [[social-engagement-system|SES]] hardware is constantly attempting to read safety from these signals — and working twice as hard to confirm what it can't fully perceive.
