...
1. **Ventral Vagal System** (most recent, mammalian): safety, social engagement, connection, neural integration
2. **Sympathetic Nervous System** (reptilian): mobilization, fight/flight, metabolic funding for action
3. **Dorsal Vagal System** (most ancient, vertebrate): immobilization, shutdown, freeze, conservation-withdrawal
...
1. **Ventral Vagal goes offline** first → lose social engagement, PFC capacity, felt safety
2. **Sympathetic activation** → fight/flight, mobilization
3. **Dorsal Vagal takes over** → shutdown, freeze, immobilization (only if threat is perceived as inescapable)
