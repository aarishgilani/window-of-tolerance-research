...
**Low HRV** = smaller regulatory reserve. System is more likely to tip into hyper- or hypo-arousal under moderate challenge. Associated with [[allostatic-load|allostatic load]] and baseline drift.
...
- Deep sleep (N3): primary time for autonomic recalibration and vagal recovery
...
- [[co-regulation]]: safe social connection as metabolic funding
- Aerobic fitness: improves arterial compliance, creating better "signaling environment" for vagal-cardiac communication

**Lowers HRV**:
- Alcohol: vagal toxin — causes withdrawal, elevated night HR, blocked N3 sleep
- [[allostatic-load]]: chronic low-level stressors create baseline drift
