...
The key neurological condition inside the window is that the **prefrontal cortex (PFC)** and the **limbic system** are in active communication. This integration allows for complex thought, reflection, empathy, and deliberate action. (Lesson 1)
...
1. **Early co-regulation**: the window is initially sized by developmental co-regulation (quality of early caregiving, safety cues in the environment). See [[co-regulation]]
2. **Allostatic load**: cumulative chronic stress shrinks the window from the bottom up, leaving less "headroom" before the system tips into hyper-arousal. See [[allostatic-load]]
