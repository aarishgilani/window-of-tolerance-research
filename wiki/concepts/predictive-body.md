...
This is the mechanism by which [[interoception|interoceptive training]] decouples chronic anxiety from minor triggers: it provides enough signal granularity to isolate the outdated prediction from the actual physiological reality.
